const ALLOWED = [
  ...
  /^research\/4ccb-h1\/run$/,
  /^research\/4ccb-h1\/status$/,
  /^research\/4ccb-h1\/[0-9a-f-]+$/i,
  /^research\/4ccb-h1-bias\/run$/,
  /^research\/4ccb-h1-bias\/status$/,
  /^research\/4ccb-h1-bias\/[0-9a-f-]+$/i,
  /^research\/4ccb-h1-structure\/run$/,
  /^research\/4ccb-h1-structure\/status$/,
  /^research\/4ccb-h1-structure\/[0-9a-f-]+$/i,
  /^research\/4ccb-h1-audit\/run$/,
  /^research\/4ccb-h1-audit\/status$/,
  /^research\/4ccb-h1-audit\/[0-9a-f-]+$/i,
