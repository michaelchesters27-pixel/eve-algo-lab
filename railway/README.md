...
No new environment variables are required for v2.5. All workers are active through safe code defaults and share the historical learning cache to reduce Railway memory use.
...
## v2.5 MT5 EA generation and Demo Eligibility
...
The `/api/mt5/eligibility` endpoint ranks generated bots by current practical availability using frozen rules, UTC/UK time and the latest stored M5 learning snapshot.
