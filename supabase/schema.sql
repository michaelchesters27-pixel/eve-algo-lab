...
-- v3.1 Demo Fleet heartbeat state
...
create index if not exists mt5_fleet_heartbeat_idx on public.mt5_fleet_instances (heartbeat_at desc);
create index if not exists mt5_fleet_strategy_idx on public.mt5_fleet_instances (strategy_code, account_login, symbol, timeframe);
create index if not exists mt5_fleet_package_idx on public.mt5_fleet_instances (package_id, heartbeat_at desc);
